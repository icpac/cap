...
namespace TCap.Module.BusinessObjects.Proyectos
{
    ...
    public class ProyectoCancelado : BaseObject
    { // Inherit from a different class to provide a custom primary key, concurrency and deletion behavior, etc. (https://documentation.devexpress.com/eXpressAppFramework/CustomDocument113146.aspx).
        public ProyectoCancelado(Session session)
            : base(session)
        {
        }
        ...
        public DateTime FchCnclcn { get; set; }

        [XafDisplayName("Motivo Cancelación")]
        [DataSourceCriteria("Tp == 'MotivoCancelacion'")]
        public CatalogoProyecto MtvCnclcnP { get; set; }
